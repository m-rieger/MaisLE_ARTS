...
### maisC all meth. {-}
```{r,  fig.cap = "Overview whether positions in maisC could be estimated by all methods ('yes', orange) or not ('no', grey) per testtrack (columns) and test transmitter (rows). Note that transmitter 2 was not used for test track C1.", fig.width = 10, fig.height = 7}
...
### maisD all meth. {-}
```{r,  fig.cap = "Overview whether positions in mais D could be estimated by all methods ('yes', orange) or not ('no', grey) per testtrack (columns) and test transmitter (rows).", fig.width = 10, fig.height = 7}
