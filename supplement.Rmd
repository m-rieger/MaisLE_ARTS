...
kbl(sum.p,
             caption = "Properties of test tracks used to compare position estimations and accuracies for maisC (<em>C1-3, Ctest</em>) and maisD (<em>D1-3, Ctest</em>). <em>N points</em> is the number of recorded GPS positions (summarized in 2-second intervals) and <em>N tags</em> the number of used transmitters.",
      row.names = F,
      escape = FALSE,
      align = c("llrrrr")) %>%
  row_spec(which(1:nrow(sum.p)%%2!=1),
